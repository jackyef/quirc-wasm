...
/* harmony import */ var _vendor_fpsmeter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var _vendor_fpsmeter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_fpsmeter__WEBPACK_IMPORTED_MODULE_1__);
...
var decodeQr = function decodeQr(_ref) {
  var byteArray = _ref.data,
      width = _ref.width,
      height = _ref.height;
  ...
  var output = jsqr__WEBPACK_IMPORTED_MODULE_0___default()(byteArray, width, height);
  console.log({
    output: output
  });
  var usedOutput = output ? output.data : 'N/A';
