...
module.exports = __webpack_require__("msIt");
...
var Module = __webpack_require__("oyTH");

var isEmptyObject = function isEmptyObject(obj) {
  return Object.entries(obj).length === 0 && _typeof(obj) === "object";
...
function () {
  function QRWorker() {
    _classCallCheck(this, QRWorker);
  }

  _createClass(QRWorker, [{
    key: "terminate",
    ...
    key: "decodeQrCode",
    value: function decodeQrCode(rawJpeg) {
      var rawJpegObj = {};
      /*
      ...
      * */
      ...
      var srcBuf = Module._malloc(rawJpegObj.asTypedArray.length * rawJpegObj.asTypedArray.BYTES_PER_ELEMENT);
      /*
      ...
      * */
      ...
      var pImage = Module._setSrcImage(srcBuf, rawJpegObj.asTypedArray.length);
      /*
      * Get the image data such as width, height, and image
      * */


      var width = Module.getValue(pImage + 0, 'i32');
      var height = Module.getValue(pImage + 4, 'i32');
      var image = Module.getValue(pImage + 8, 'i32');
      /*
      * Decode image data and return the result
      * */

      var QUIRC_MAX_PAYLOAD = 8896;

      var resultPtr = Module._decode_qr(image, width, height);

      var strArray = [];

      for (var pointer = 0; pointer < QUIRC_MAX_PAYLOAD; pointer++) {
        var _char = Module.HEAP8[resultPtr / Uint8Array.BYTES_PER_ELEMENT + pointer];
      ...
      var resultStr = String.fromCharCode.apply(null, strArray);
      /*
      * Clean the buffer
      * */
